...
namespace iFredApps.TimeTracker.Core.Interfaces.Services
{
   public interface ISessionService
   {
      ...
      Task<Result<IEnumerable<Session>>> GetUserSessionsByDescription(int user_id, int workspace_id, string description, DateTime? start_date = null, DateTime? end_date = null);
